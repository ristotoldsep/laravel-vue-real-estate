export default {
    ...
    column: {
        headercell: ({ context, props }) => ({
            class: [
                ...
                "border-1 border-b border-primary-100 border-solid",
                ...
                (props.sortable === "" || props.sortable) && context.sorted
                    ...
                    : "bg-primary-50 text-primary-700",
                // (props.sortable === '' || props.sortable) && context.sorted ? 'dark:text-white dark:bg-primary-400/30' : 'dark:text-white/80 dark:bg-primary-800',
                // 'border-primary-200 ',
        ...
        filterrowitem: ({ context }) => ({
            class: [
                ...
                {
                    "bg-primary-0 text-primary-700 ":
                        !context?.highlighted,
                },
                {
                    "bg-primary-100 dark:bg-primary-400/40 text-primary-700 ":
                        context?.highlighted,
                },
                {
                    "bg-primary-50 dark:bg-primary-400/40 text-primary-70":
                        context?.highlighted,
                },
        ...
        filteroperatordropdown: {
            ...
            input: ({ props }) => ({
                class: [
                    ...
                    "border-0",
                    {
                        "text-primary-800": props.modelValue,
                        "text-primary-400 ":
                            !props.modelValue,
                    },
                    "placeholder:text-primary-400",
            ...
            item: ({ context }) => ({
                class: [
                    ...
                    {
                        "bg-primary-50 dark:bg-primary-600/60 text-primary-700":
                            context.focused && !context.selected,
                    },
                    {
                        "bg-primary-100 dark:bg-primary-400/40 text-primary-700":
                    ...
                    {
                        "bg-primary-50 dark:bg-primary-400/40 text-primary-700":
                            !context.focused && context.selected,
                    },
        ...
        filtermenubutton: ({ context }) => ({
            class: [
                ...
                // States
                "hover:text-primary-700 hover:bg-primary-300/20",
        ...
        rowtoggler: {
            class: [
                ...
                // Color
                "text-primary-500 dark:text-white/70",
                "bg-transparent",
        ...
        radiobutton: ({ context }) => ({
            class: [
                ...
                // Color
                { "text-primary-700 dark:text-white/80": !context.checked },
                { "bg-primary-0 dark:bg-primary-900": !context.checked },
                {
        ...
        headercheckbox: ({ context }) => ({
            class: [
                ...
                "text-primary-600",
                {
                    "border-primary-200 bg-primary-0 dark:border-primary-700 dark:bg-primary-900":
                        !context.checked,
    ...
    bodyrow: ({ context, props }) => ({
        class: [
            ...
            {
                "bg-primary-0 text-primary-600":
                    !context.selected,
            },
            { "font-bold bg-primary-0": props.frozenRow },
            {
                "odd:bg-primary-0 odd:text-primary-600 dark:odd:bg-primary-800 even:bg-primary-50 even:text-primary-600 dark:even:bg-primary-900/50":
                    context.stripedRows,
            },
            ...
            {
                "hover:bg-primary-300/20 hover:text-primary-600":
