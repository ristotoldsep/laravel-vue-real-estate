export default {
    ...
    container: ({ props }) => ({
        class: [
            ...
            // Colors
            {
                ...
                'bg-primary-400': props.message.severity == 'success',
            ...
            },
            {
                ...
                'border-primary-500': props.message.severity == 'success',
            ...
            },
            {
                ...
                'text-primary-50': props.message.severity == 'success',
    ...
    detail: {
        class: 'mt-2 block font-quicksand'
    },
    closebutton: {
        class: [
            // Flexbox
