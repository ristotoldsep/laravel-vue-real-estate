    ...
    tabpanel: {
        ...
        headerAction: ({ parent, context }) => ({
            class: [
                ...
                {
                    'border-primary-100': parent.state.d_activeIndex !== context.index,
                    'bg-transparent': parent.state.d_activeIndex !== context.index,
                    'text-primary-300': parent.state.d_activeIndex !== context.index,
                ...
                'focus-visible:ring-primary-400/50 dark:focus-visible:ring-primary-300/50',
                {
                    ...
                    'hover:text-primary-700': parent.state.d_activeIndex !== context.index
                },
